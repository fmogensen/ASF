...
| --- | --- | --- | --- |
| R1 | pending | `tests/test_lane.py::R1LaneStateOnTheRunLine::test_r1_lane_state_on_the_run_line_no_lanes_jsonl` | lane stream (W1+W3) |
| R2 | pending | `tests/test_lane.py::R2InProcessBeforeTheWave::test_r2_feeder_visible_transitions_before_the_wave` | lane stream (W1+W3) |
| R3 | pending | `tests/test_lane.py::R3MergingIntent::test_r3_merging_intent_is_ours` | lane stream (W1+W3) |
| R4 | pending | `tests/test_lane.py::R4HeadMoved::test_r4_head_moved_is_pushed_with_the_new_head` | lane stream (W1+W3) |
| R5 | pending | `tests/test_lane.py::R5Queued::test_r5_queue_rejected_is_back_or_waiting` | lane stream (W1+W3) |
| R6 | pending | `tests/test_lane.py::R6Reopened::test_r6_reopened_pr_is_pr_open` | lane stream (W1+W3) |
| R7 | pending | `tests/test_e2e_lane.py::DocsRedOnGatePR::test_r7_fault1_docs_pr_red_on_the_product_gate_never_merges`, `tests/test_e2e_lane.py::DocsRedOnGateFF::test_r7_fault1_docs_pr_red_on_the_product_gate_never_merges` | W5 harness; FF is an expected failure until the lane lands |
| R8 | pending | `tests/test_e2e_lane.py::CrashAfterMergePR::test_r8_crash_between_merge_and_ledger_is_recoverable`, `tests/test_e2e_lane.py::CrashAfterMergeFF::test_r8_crash_between_merge_and_ledger_is_recoverable` | W5 harness; both expected failures until the lane lands |
...
| R12 | pending | `tests/test_invariants.py::R12I9IsAnEvent::test_r12_a_human_merge_is_an_event_not_a_violation`, `tests/test_invariants.py::R12I9IsAnEvent::test_r12_the_lane_report_logs_the_event_and_returns_no_finding`, `tests/test_e2e_lane.py::HumanMergePR::test_r12_human_merge_is_landed_not_foreign` | W4 event done; the e2e human merge is an expected failure until the lane lands |
...
| R16 | n/a |  | process: W1 and W3 run as one lane stream, which owns `asf/harvest/*`, `asf/feeder/*`, `lifecycle.py` and `health.py` |
...
| R19 | pending | `tests/test_e2e_lane.py::HappyPathPR::test_r19_s1_card_to_merge_resolves_the_feature`, `tests/test_e2e_lane.py::HappyPathFF::test_r19_s1_card_to_merge_resolves_the_feature`, `tests/test_e2e_lane.py::RedTrunkPR::test_r19_s2_red_trunk_waits_then_lands`, `tests/test_e2e_lane.py::RedTrunkFF::test_r19_s2_red_trunk_waits_then_lands`, `tests/test_e2e_lane.py::SquashMergePR::test_r19_s4_landed_task_closes_open_sibling_keeps_feature_open`, `tests/test_e2e_lane.py::SquashMergeFF::test_r19_s4_landed_task_closes_open_sibling_keeps_feature_open`, `tests/test_e2e_lane.py::PreexistingPRPR::test_r19_s5_open_pr_is_adopted_not_rebuilt`, `tests/test_e2e_lane.py::PreexistingPRFF::test_r19_s5_open_pr_is_adopted_not_rebuilt` | W5 harness; the FF modes are expected failures until the lane lands |
...
| R25 | pending | `tests/test_lane.py::R25DocsOnlyTrunk::test_r25_docs_only_trunk_move_does_not_regate` | lane stream (W1+W3) |
