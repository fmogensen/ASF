...
Why this session exists: STARVED → SPEC — spec-draft, the card changed
...
DELIVERABLE: `docs/specs/checkout-resilience.md`, which **already exists on this branch**, amended in place.
